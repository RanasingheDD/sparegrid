MARKETPLACE_POLICIES = {
    ...
    "seller_payment_release_rule": "Sellers are paid only after SpareGrid verifies the part.",
    "seller_agreement": [
        "Seller must ship the item to SpareGrid within 48 hours after order confirmation.",
        "SpareGrid releases seller payments only after the part is verified by the SpareGrid team.",
        "All seller payment handling is processed on Fridays.",
        "If a buyer rejects the part after review, SpareGrid returns the item and charges delivery cost.", 
    ...
    "terms_sections": [
        {
            ...
            "items": [
                ...
                "If a buyer rejects the part, SpareGrid sends the item back and charges delivery cost.", 
